    ...
    <div>
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4" id="dashboard-stats">
          <StatsCard icon="👥" label="Total Users" value={stats?.totalUsers} bgColor="bg-blue-50" />
          <StatsCard icon="🏪" label="Total Stores" value={stats?.totalStores} bgColor="bg-emerald-50" />
          <StatsCard icon="⭐" label="Total Ratings" value={stats?.totalRatings} bgColor="bg-yellow-50" />
        </div>
      )}
    </div>
  );
